...
Plotting R_effective over time can help us these dynamics.
...
R_effective declines over time as susceptibles are consumed and become immune, and dives below 1.0 at the peak of transmission before this decline slows down.
School closures reduce transmission and drop R_effective.
The late school closure (blue) brings R_effective below 1.0, but the closure is in effect long enough to prevent bounce-back by allowing more people to get infected. When schools re-open, R_effective is still below 1.0 but a substantial number of cases will be generated, nearly catching up to the no-closure scenario.
