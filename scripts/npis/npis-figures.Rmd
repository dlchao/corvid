...
temp <- data.frame(before.shutdown=as.vector(table(individuals$SOURCETYPE[individuals$infectedday<responseday], exclude=NA)),
                   during.shutdown=as.vector(table(individuals$SOURCETYPE[individuals$infectedday>responseday & individuals$infectedday<responseday+responselength], exclude=NA)))
