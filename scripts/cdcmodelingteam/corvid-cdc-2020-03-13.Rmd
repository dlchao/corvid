...
temp <- data.frame(setting=c("school","work","home","community","total"),
	   ...
	   sum(individuals.seattle25$SOURCETYPE %in% c("daytime.comm","daytime.nh","nighttime.comm","nighttime.nh"),na.rm=TRUE),
	   ...
	   sum(individuals.seattle20$SOURCETYPE %in% c("daytime.comm","daytime.nh","nighttime.comm","nighttime.nh"),na.rm=TRUE),
